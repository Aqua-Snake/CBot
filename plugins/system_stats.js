...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'alive', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
        ...
        if (Config.ALIVEMSG == 'default') {
            await message.client.sendMessage(message.jid,'```Powered by Cyber Army !```\n\n*Version:* ```'+Config.VERSION+'```\n*Telegram Channel:* https://t.me/Bot_support_for_users\n*Telegram Channel:* https://t.me/asenaremaster\n*Plugin Channel:* ' + Config.CHANNEL , MessageType.text);
        }
        else {
    ...
    Asena.addCommand({pattern: 'alive', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
        ...
        if (Config.ALIVEMSG == 'default') {
            await message.client.sendMessage(message.jid,'```Cyber Army !```\n\n*Version:* ```'+Config.VERSION+'```\n*Telegram Channel:* https://t.me/Bot_support_for_users\n*Telegram Channel:* https://t.me/asenaremaster\n*Plugin Channel:* ' + Config.CHANNEL, MessageType.text);
        }
        else {
            const pow = '*Powered by Cyber Army Bot*'
            const payload = Config.ALIVEMSG
