...
CBot.applyCMD({ pattern: 'animesay ?(.*)', fromMe: LOL, desc: Lang.ANIME_DESC ,  deleteCommand: false}, (async (message, match) => {
...
CBot.applyCMD({ pattern: 'changesay ?(.*)', fromMe: LOL, desc: Lang.CHANGE_DESC ,  deleteCommand: false}, (async (message, match) => {
...
CBot.applyCMD({ pattern: 'trumpsay ?(.*)', fromMe: LOL, desc: Lang.TRUMP_DESC,  deleteCommand: false }, (async (message, match) => {
