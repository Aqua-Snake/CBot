...
CBot.applyCMD({pattern: 'welcome$', fromMe: true,  deleteCommand: false, desc: Lang.WELCOME_DESC, dontAddCommandList: true}, (async (message, match) => {
...
CBot.applyCMD({pattern: 'welcome (.*)', fromMe: true,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
...
CBot.applyCMD({pattern: 'goodbye$', fromMe: true,  deleteCommand: false, desc: Lang.GOODBYE_DESC, dontAddCommandList: true}, (async (message, match) => {
...
CBot.applyCMD({pattern: 'goodbye (.*)', fromMe: true,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
