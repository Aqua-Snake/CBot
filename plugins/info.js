...
if (Config.WORKTYPE == 'private') {
    CBot.applyCMD({ pattern: 'info', fromMe: true, desc: Lang.INFO_DESC, deleteCommand: false}, async (message, match) => { 
    ...
    CBot.applyCMD({ pattern: 'info', fromMe: false, desc: Lang.INFO_DESC}, async (message, match) => { 
