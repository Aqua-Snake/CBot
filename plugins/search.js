/*
Cyber Bot Bot - A whatsapp user bot.
...
CBot.applyCMD({ pattern: 'mod ?(.*)', fromMe: LOL, desc: Lang.USAGE,  deleteCommand: false }, async (message, match) => {
...
CBot.applyCMD({ pattern: 'getspo ?(.*)', fromMe: LOL, desc: Lang.SPO_USAGE,  deleteCommand: false }, async (message, match) => {
...
CBot.applyCMD({ pattern: 'getpack ?(.*)', fromMe: LOL, desc: Lang.APK_DESC,  deleteCommand: false }, async (message, match) => {
...
/* WORKING IN PROGRESS
CBot.applyCMD({ pattern: 'getsong ?(.*)', fromMe: LOL, desc: Lang.FIND_DESC,  deleteCommand: false }, async (message, match) => {
