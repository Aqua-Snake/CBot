...
CBot.applyCMD({pattern: 'bts ?(.*)', fromMe: LOL, desc: Lang.BTS_DESC,  deleteCommand: false}, (async (message, match) => {
...
CBot.applyCMD({pattern: 'exo ?(.*)', fromMe: LOL, desc: Lang.EXO_DESC,  deleteCommand: false}, (async (message, match) => {
...
CBot.applyCMD({pattern: 'blackpink ?(.*)', fromMe: LOL, desc: Lang.BP_DESC,  deleteCommand: false}, (async (message, match) => {
...
CBot.applyCMD({pattern: 'ewallpaper ?(.*)', fromMe: LOL, desc: Lang.BP_DESC,  deleteCommand: false}, (async (message, match) => {
