...
if (Config.WORKTYPE == 'private') {
    ...
    CBot.applyCMD({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true,  deleteCommand: false}, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    CBot.applyCMD({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false}, async (message, match) => {
