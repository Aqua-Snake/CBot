...
CBot.applyCMD({pattern: 'term ?(.*)', fromMe: true, desc: Lang.TERM_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
CBot.applyCMD({pattern: 'print ?(.*)', fromMe: true, desc: p_desc, dontAddCommandList: true}, (async (message, match) => {    
